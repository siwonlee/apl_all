   ...
   @if($segment2=='2')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/2/301')}}">301</a></li>
  ...
  @endif
   ...
   @if($segment2=='5')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/5/101')}}">101</a></li>
  ...
  <li class="page-item"><a class="page-link"  href="{{asset('approved/6/5')}}">5</a></li>
  ...
  @endif
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/8/4')}}">4</a></li>
    <li class="page-item"><a class="page-link"  href="{{asset('approved/8/6')}}">6</a></li>
  ...
  @endif
   @if($segment2=='16')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/16/201')}}">201</a></li>
    <li class="page-item"><a class="page-link"  href="{{asset('approved/16/202')}}">202</a></li>
...
{{--
  ...
  @endif
   ...
   @if($segment2=='51')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/51/13')}}">13</a></li>
    <li class="page-item"><a class="page-link"  href="{{asset('approved/51/101')}}">101</a></li>
  ...
  @endif
   ...
   @if($segment2=='52')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/52/3')}}">3</a></li>
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/52/16')}}">16</a></li>
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/52/101')}}">101</a></li>
    <li class="page-item"><a class="page-link"  href="{{asset('approved/52/102')}}">102</a></li>
  ...
  @endif
   ...
   @if($segment2=='53')
    ...
    <li class="page-item"><a class="page-link"  href="{{asset('approved/53/201')}}">201</a></li>
  @endif

   @if($segment2=='54')
    <li class="page-item"><a class="page-link"  href="{{asset('approved/54/2')}}">2</a></li>
    <li class="page-item"><a class="page-link"  href="{{asset('approved/54/201')}}">201</a></li>
